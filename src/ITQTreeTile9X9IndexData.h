#ifndef	__ITQTreeTile9X9Datas_H__ 
#define	__ITQTreeTile9X9Datas_H__


//
// 最低的LOD，只渲染两个三角形构成的一个片
// |--|
// |\ |
// | \|
// |--|
...
// 在四个边如果分别连接到Level0的话，需要做如下处理：
// 如果连接到Level2、3，在后面
// 因为我们是希望只向下算，所以1不向2、3算
...
//
// LOD 2：将9 X 9的Tile方阵缩减为4 X 4，也就是总共画16个正方形，32个三角形
// 这就有个Center和Side的问题了：
// |-|-|-|-|
// |\|/|\|/|
// |-0=0=0-|
...
// |/|\|/|\|
// |-|-|-|-|
// 那么被0所包围的这四个正方形（8个三角形）是Center，其余的24个三角形都是Side
//
...
//
// LOD3：所有的顶点全都画出来：总共画64个正方形（128个三角形）
// 其中靠边的28个正方形（56个三角形）是Side，其余的都是Center
//
...
#endif//__ITQTreeTile9X9Datas_H__